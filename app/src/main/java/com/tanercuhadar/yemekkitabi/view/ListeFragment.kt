...
import com.tanercuhadar.yemekkitabi.adapter.TarifAdapter
import com.tanercuhadar.yemekkitabi.databinding.FragmentListeBinding
...
class ListeFragment : Fragment() {
    ...
    private fun verileriAl(){
        mDisposable.add(
            tarifDao.getAll().subscribeOn(Schedulers.io())
